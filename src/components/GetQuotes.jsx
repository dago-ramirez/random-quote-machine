...
export default function GetQuotes() {
    ...
    return (
        <div style={bgColor} className="App h-screen transition duration-1000 ease-in-out flex items-center justify-center" id="quote-box">
            <div className="w-full md:w-8/12 lg:w-6/12 min-h-96 rounded overflow-hidden bg-gray-100 shadow-lg">
                <h1 style={textColor} className="transition-colors duration-1000 ease-in-out text-2xl md:text-3xl text-center font-bold mb-3" id="text">"{quote}"</h1>
                <p style={textColor} className="transition-colors duration-1000 ease-in-out text-right pr-5 justify-center text-xl md:text-3xl" id="author">{author}</p>
